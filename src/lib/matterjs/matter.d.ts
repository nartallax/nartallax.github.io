// those typedefs are copied here from npm
// to avoid accidently importing non-existent npm module
// because implementation is not in the npm, it's in ./matter.js file
